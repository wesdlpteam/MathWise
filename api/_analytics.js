...
export const CATEGORIES = {
  ...
  "topic": [
    ...
    "Financial mathematics", "Fractions, decimals and percentages", "Functions",
    "Functions, relations and graphs", "Geometry and measurement",
    "Geometry and trigonometry", "Geometry, measurement and trigonometry",
    "Graphs of linear and non-linear relations", "Histograms and comparing distributions",
    "Index laws", "Indices and prime factorisation", "Indices and scientific notation",
    "Indices and surds", "Integers and negative numbers", "Introducing non-linear graphs",
    "Linear and simultaneous equations", "Linear equations",
